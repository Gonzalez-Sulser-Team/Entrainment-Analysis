...
def init_params(): #Defines initial parameters used throughout.
    prm.set_filepath('C:\\Users\\Alfredo\\Desktop\\Tethered Recordings\\190627\\2019-06-27_13-22-41\\')
...
del(data)
picks=[32, 46, 38, 40, 42, 64]  #[16, 30, 22, 24, 26, 64]#b[32, 46, 38, 40, 42, 64] #c  [0, 14, 6, 8, 10, 64] #a[32, 46, 38, 40, 42, 64] #c    [48, 62, 54, 56, 58, 64] #d 
...
ext_times_1j_alltrodes_baseline_1st, ext_times_1j_alltrodes_stim_1st, phase_angles_baseline_1st, phase_angles_stim_1st  = ispc_trials_return_exponential_1j_over_time(hil_data_baseline, hil_data_stim, channel_combo)

'Run for second animal'

'This loads data in numpy to get stim times'

prm.set_filepath('C:\\Users\\Alfredo\\Desktop\\Tethered Recordings\\190627\\2019-06-27_15-30-00\\')
picks=[32, 46, 38, 40, 42, 64] 
data=load_16channel_opto(prm.get_headstages())
stimulations = actual_stim_times(data,  prm.get_sampling_rate(), prm.get_headstages())  
stim=create_epochs(stimulations, prm.get_sampling_rate()) #Creates stim time array that MNE can read.
channel_combo=import_channel_combo(prm.get_excelpath() + prm.get_channel_combo_name())
...
ext_times_1j_alltrodes_baseline_2nd, ext_times_1j_alltrodes_stim_2nd, phase_angles_baseline_2nd, phase_angles_stim_2nd = ispc_trials_return_exponential_1j_over_time(hil_data_baseline, hil_data_stim, channel_combo)
#
#
#
...
all_phase_angles_baseline= concatenate ((phase_angles_baseline_1st, phase_angles_baseline_2nd), axis=0)  
all_phase_angles_stim = concatenate((phase_angles_stim_1st, phase_angles_stim_2nd), axis=0)
...
stimdif=all_phase_angles_stim[:,5, 35]-all_phase_angles_stim[:,0,35]#
baselinedif=all_phase_angles_baseline[:,5, 35]-all_phase_angles_baseline[:,0,35]
